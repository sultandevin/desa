				...
				<section className="relative overflow-hidden border-b bg-gradient-to-b from-muted/50 to-background">
					<div className="container mx-auto px-4 py-20 md:py-32">
						<div className="mx-auto max-w-4xl text-center">
							<pre className="mb-6 overflow-x-auto text-center font-mono text-xs leading-tight text-primary sm:text-sm md:text-base">
								{DESA_ASCII}
							</pre>
							...
							<p className="mb-8 text-lg text-muted-foreground md:text-xl">
								Platform digital terpadu untuk pengelolaan administrasi desa
								yang efisien, transparan, dan modern
							</p>
