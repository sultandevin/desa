...
export default function () {
  ...
  const res1 = http.get(`${BASE_URL}/api/rpc/damage-reports?limit=20&offset=0`, {
    headers: {
  ...
  const res2 = http.get(`${BASE_URL}/api/rpc/damage-reports?limit=${randomPageSize}&offset=0`, {
    headers: {
      'Content-Type': 'application/json',
    },
  });
  ...
  const res3 = http.get(`${BASE_URL}/api/rpc/damage-reports?limit=15&offset=${randomOffset}`, {
    headers: {
      'Content-Type': 'application/json',
    },
  });
